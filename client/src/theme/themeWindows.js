 ...
 *
 * Deliberately CommonJS (not ESM): client/package.json has no "type" field,
 * so Node treats .js files here as CommonJS and the prebuild script can load
 * this module directly without a build step, while webpack/babel interop
 * handles it for the browser bundle. Keep this file free of imports.
 */
